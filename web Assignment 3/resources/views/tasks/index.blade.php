                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="small fw-bold">
                                        {{ $todo->due_date ? date('d M Y', strtotime($todo->due_date)) : 'No date' }}
                                    </div>
                                </td>
                                <td>
                                    <span class="badge-priority {{ strtolower('priority-' . $todo->priority) }}">
                                        {{ $todo->priority }}
                                    </span>
                                </td>
                                <td>
                                    <span class="badge-status {{ $todo->status == 'Completed' ? 'status-completed' : 'status-pending' }}">
                                        {{ $todo->status ?? 'Pending' }}
                                    </span>
                                </td>
                                <td>
                                    <div class="d-flex gap-2">
                                        <a href="{{ route('todos.edit', $todo->id) }}" class="action-btn edit-btn" title="Edit">
                                            <small>📝</small>
                                        </a>
