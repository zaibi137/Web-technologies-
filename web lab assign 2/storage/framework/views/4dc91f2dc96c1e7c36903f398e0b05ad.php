...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                <label>CNIC</label>
                <input type="text" name="cnic" value="<?php echo e(old('cnic')); ?>" class="form-control" placeholder="35202-1234567-1">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-6">
                ...
                <input type="text" name="telephone" value="<?php echo e(old('telephone')); ?>" class="form-control" placeholder="0300-1234567">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="col-md-12">
                ...
                <textarea name="comments" class="form-control" rows="4"><?php echo e(old('comments')); ?></textarea>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\XAMP\htdocs\SmartProfileManagementSystem\resources\views/users/create.blade.php ENDPATH**/ ?>